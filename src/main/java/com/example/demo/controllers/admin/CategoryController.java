...
public class CategoryController implements IController<Category> {
    ...
    @Override
    public String list(Model model, @RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int offset) {
    ...
    public String edit(Model model, Long id) {
        List<Category> listParentCategory = categoryService.getCategories(id);
        model.addAttribute("parents", listParentCategory);
    ...
    @Override
    public String doEdit(Category gModel, Long id, RedirectAttributes attributes, String password) {
